...
#
# Tuned for a 12 GB Blackwell card (RTX 5070) + 32 GB RAM with Qwen3.6-35B-A3B
# (MoE, ~17.7 GB at UD-IQ4_XS): expert tensors spill to RAM while attention stays
# on the GPU — interactive because only ~3.5B params fire per token. Old Qwen3-Coder
# remains reachable via HARNESS_LOCAL_MODEL=unsloth/Qwen3-Coder-30B-A3B-Instruct-GGUF:IQ4_XS
...
NCPUMOE="${HARNESS_LOCAL_NCPUMOE:-28}"
