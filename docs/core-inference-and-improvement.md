...
active. Local runtime readiness, distinct agent task results, experiment runners,
activation, and rollback are subsequent work.
...
The separate agent task/progress/artifact/result contract still needs migration.
