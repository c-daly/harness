...
Current implementation branch: `feat/shared-inference-budget`, based on merged
`main` at `0184e00` (PR45, escalation against declared task evidence).
